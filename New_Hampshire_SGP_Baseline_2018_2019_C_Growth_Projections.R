###########################################################################################
###                                                                                     ###
###   New_Hampshire Learning Loss Analyses -- 2018-2019 Baseline Growth Projections     ###
###                                                                                     ###
###########################################################################################
...
SGPstateData <- SGPmatrices::addBaselineMatrices("NH", "2020_2021")
